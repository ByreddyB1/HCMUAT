...
import eccDocketRequest  from '@salesforce/apex/eccDocketRequestController.eccDocketRequest';
import createDocketRequestECC from '@salesforce/apex/eccDocketRequestController.createDocketRequestECC';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { RefreshEvent } from "lightning/refresh";

const columns = [   
	{label: 'Assessment Number', fieldName: 'AssessmentNumber', type: 'Text',initialWidth:80},
	{label: 'Intent Date', fieldName: 'IntentDate', type: 'text',initialWidth:80},
	{label: 'Tax Type', fieldName: 'TaxType', type: 'Text',initialWidth:80},
    ...
    {label: 'Form Bundle Type', fieldName: 'FormBundleType', type: 'text',initialWidth:80}, 
];
...
export default class MiTreasDocRequestLWC extends LightningElement {
    ...
    fetchECCData() {
		...
		// fetch ECC records from Apex method.
		eccDocketRequest({
...
/*
   ...
   createDocketRequestCDR(event){
    ...
    //if(this.selectedRows.length > 0){
            ...
            createDocketRequestECC({docketId: this.recordId, selectionList: JSON.stringify( this.selectedRecords )})
            .then(() => {
